...
export const Home = () => {
  ...
  const goal = (
    <Section tag="OUR GOAL" subtitle="Capture each and every beautiful moment">
      <Description>
        These days it's so easy to pull out your phone and take a photo, but you
        aren't able to be in the moment. Our goal at Krystina Rose Photography
        is to allow you to enjoy those memories to the fullest and let us
        capture them so you can cherish them for a lifetime.
      </Description>
    </Section>
  );
